...
import os
import sys
#BASE_DIR = os.path.dirname(os.path.abspath(__file__)) #/media/jcc/xr/xrhh/3D/program/pointnet2-master
BASE_DIR = '/media/jcc/xr/xrhh/3D'
ROOT_DIR = '/media/jcc/xr/xrhh/3D/program/pointnet2-master'
...
parser.add_argument('--normal', default=0, action='store_true', help='Whether to use normal information')
